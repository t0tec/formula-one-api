...
@WebAppConfiguration
public class ITFindCircuitByIdTest {
  ...
  private static final String ERROR_MESSAGE_KEY_CIRCUIT_ENTRY_NOT_FOUND
      = "No circuit entry was found by using id: " + ID;
  ...
  public void findByIdCircuitEntryNotFoundShouldReturnResponseStatusNotFound() throws Exception {
    mockMvc.perform(get("/api/circuit/id/{id}", ID))
        .andExpect(status().isNotFound());
  }

  @Test
  @DatabaseSetup("classpath:circuit-no-data.xml")
  public void findByIdCircuitEntryNotFoundShouldReturnErrorMessageAsJson() throws Exception {
  ...
  public void findByIdCircuitEntryFoundShouldReturnInformationOfFoundCircuitEntryAsJson()
      throws Exception {
    mockMvc.perform(get("/api/circuits/id/{id}", ID))
